...
import com.huake.admin.model.AddProductDao;
...
public class AddProductServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Product pro = uploadImage(request, response);
		AddProductDao dao = new AddProductDao();
		int res = dao.addProduct(pro);
		request.getRequestDispatcher("/showpro").forward(request, response);
	}
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		doGet(request, response);
	}
	private Product uploadImage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
